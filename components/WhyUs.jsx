  ...
  return (
    <section className="mt-20">
      <div className="my-container">
        <div className="w-full h-130 my-text"  style={{ backgroundImage: "url(./img/Frame.png" }}>
          {/* title */}
          ...
          {/* body */}
          <div className="mt-8 bg-primary flex items-center gap-6 dark:border dark:border-[#FBFBFB]/25 dark:bg-[#1D1D1D] justify-between p-10 rounded-4xl">
            <div className="bg-[#7D8BFF] dark:bg-[#4A4A4A] flex flex-col flex-1/3 items-center gap-y-5 relative rounded-4xl p-5 after:bg-[#7D8BFF] dark:after:bg-[#4A4A4A] after:rounded-full after:w-20 after:h-20 after:absolute after:-top-3 after:left-[42%]">
