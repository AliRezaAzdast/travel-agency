  ...
  return (
    <section className="my-container mt-3 relative">
      <div className="flex lg:flex-row flex-col items-center justify-between my-text">
        ...
        <div
          ref={imageRef}
          className="lg:w-[636px] w-full lg:h-[811px] h-[300px] rounded-4xl bg-bottom bg-cover relative"
      ...
      <div
        ref={borderRef}
        className=" rounded-4xl lg:rounded-full w-full lg:w-250 lg:absolute mt-8 mx-auto lg:bottom-8 bg-white p-4 dark:bg-dark-background dark:border-white/35 border border-[#404040]/35"
      >
        <ul className="flex lg:flex-row flex-col text-xl gap-6 justify-evenly items-center">
          <DropDownMneu
            animationClass={""}
            menuTitle={"مقصد خود را انتخاب کنید"}
            svgItem={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          />
          <li>
            <button className="bg-primary rounded-full text-white text-xl font-semibold px-10 py-3 cursor-pointer">
              جستجو
            </button>
          </li>
        </ul>
